...
/**
 * Servlet implementation class ServletListaFilmesDoGenero2
 */
@WebServlet("/listaFilmesDoGenero2")
public class ServletListaFilmesDoGenero2 extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ServletListaFilmesDoGenero2() {
        super();
	...
	String idgenero = request.getParameter("idgenero");
		...
		RequestDispatcher rd = request.getRequestDispatcher("respostaListaFilmesDoGenero2.jsp");
