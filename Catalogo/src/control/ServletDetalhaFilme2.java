...
/**
 * Servlet implementation class ServletDetalhaFilme2
 */
@WebServlet("/detalhaFilme2")
public class ServletDetalhaFilme2 extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ServletDetalhaFilme2() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		RequestDispatcher rd = request.getRequestDispatcher("/respostaDetalhaFilme2.jsp");
